...
P_LED=15;%we change this from 15 to 25
...
d1_2 = sqrt(((xM-x0)-xilc(1,2)).^2 + ((yM-y0)-yilc(1,2)).^2);
d1_3 = sqrt(((xM-x0)-xilc(1,3)).^2 + ((yM-y0)-yilc(1,3)).^2);
d1_4 = sqrt(((xM-x0)-xilc(1,4)).^2 + ((yM-y0)-yilc(1,4)).^2);
d1_5 = sqrt(((xM-x0)-xilc(1,5)).^2 + ((yM-y0)-yilc(1,5)).^2);
d1_6 = sqrt(((xM-x0)-xilc(1,6)).^2 + ((yM-y0)-yilc(1,6)).^2);
d1_7 = sqrt(((xM-x0)-xilc(1,7)).^2 + ((yM-y0)-yilc(1,7)).^2);
d1_8 = sqrt(((xM-x0)-xilc(1,8)).^2 + ((yM-y0)-yilc(1,8)).^2);
...
for i=1:size(xM1,2)
   ...
   if xM1(i) == 100 || xM1(i) == 1 && yM1(i) == 100 || yM1(i) == 1
       H_A1(xM1(i),yM1(i))=0;
       H_A2(xM1(i),yM1(i))=0;
       H_A3(xM1(i),yM1(i))=0;
       H_A4(xM1(i),yM1(i))=0;
...
P_rec_A2(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A3(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A4(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A5(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A6(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A7(find(abs(receiver_angle_1)>FOV))=0;
P_rec_A8(find(abs(receiver_angle_1)>FOV))=0;
...
power=power+sum(sum(P_rec_total))/10000;
end
      mean_power=power/10000;
      mean_db=10*log10(mean_power);
      mean(end+1)=mean_db; 
      blockages(end+1)=b;
end
plot(blockages,mean);
